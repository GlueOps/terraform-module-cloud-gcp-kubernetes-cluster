...
A reasonable example configuration for this module can be found below, **be sure to update `project_id`, required**, and `region`, if desired.  The region should be the same as the region for which the quota increase was requested above:
